...
interface AudienceTargetProps<T extends AudienceTargetData = AudienceTargetData> {
    formData: Partial<T>;
...
export function AudienceTarget<T extends AudienceTargetData>({
    formData,
    setFormData,
}: AudienceTargetProps<T>) {
    ...
    const handleLocationSelect = (locationId: string) => {
        const currentLocations = (formData.locations || []) as string[];
    ...
    const handleSelect = (field: keyof T, id: string) => {
        const selectedIds = ((formData as any)[field] as string[]) || [];
        ...
        <div className="space-y-4">
            ...
            {formData.audienceTarget?.includes("location") && (
                <div className="space-y-2">
                    ...
                    <div className="pt-1 flex flex-wrap gap-1">
                        {(formData.locations || []).map((id: string) => (
                            <Badge
                                variant="secondary"
                                key={id}
