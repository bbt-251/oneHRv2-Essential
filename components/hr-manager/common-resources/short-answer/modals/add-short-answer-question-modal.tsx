...
import { createShortAnswer } from "@/lib/backend/api/talent-acquisition/short-answer-service";
...
interface AddShortAnswerQuestionModalProps {
    isOpen: boolean;
    onClose: () => void;
}

export default function AddShortAnswerQuestionModal({
    isOpen,
    onClose,
}: AddShortAnswerQuestionModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent): Promise<void> => {
        ...
        try {
            ...
            const result = await createShortAnswer(shortAnswer);
            if (result) {
                showToast(
                ...
                showToast("Error creating short answer. Please try again.", "Error", "error");
            }
        } catch (error) {
            showToast("Failed to create question. Please try again.", "Error", "error");
        }
        ...
        <>
            <Dialog open={isOpen} onOpenChange={onClose}>
                <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
                    <DialogHeader>
                        <DialogTitle>Create Short Answer Question</DialogTitle>
                    </DialogHeader>
