...
const CreateHeaderDialog: React.FC<CreateHeaderDialogProps> = ({
    open,
    onOpenChange,
    onSuccess,
}) => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (result) {
                showToast("Header created successfully", "Success", "success");
                setFormData({
                    name: "",
                    type: "",
                    active: true,
                ...
                showToast("Error creating header", "Error", "error");
            }
        } catch (error) {
