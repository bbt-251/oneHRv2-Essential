...
interface HROvertimeDetailModalProps {
    isOpen: boolean;
    onClose: () => void;
...
export function HROvertimeDetailModal({
    isOpen,
    onClose,
    request,
    employees,
            ...
            <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    <div className="flex items-center justify-between">
                        ...
                        >
                            HR Review - Overtime Request Details
                        </DialogTitle>
                    </div>
                </DialogHeader>
                ...
                <div className="space-y-6">
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-start justify-between mb-4">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div
                                        className={`px-3 py-1 rounded-full text-sm font-medium border ${getOvertimeTypeColor(request.overtimeType)}`}
                                        style={{ fontFamily: "Montserrat, sans-serif" }}
                                    >
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="flex items-center gap-1">
                                            ...
                                            >
                                                <MoreHorizontal className="h-5 w-5 text-[#3f3d56] dark:text-white" />
                                            </Button>
                                        </div>
                                        <p
                                ...
                                <div className="space-y-4">
                                    <div className="bg-gray-50 dark:bg-black p-4 rounded-lg">
                                        <div className="grid grid-cols-2 gap-4">
                                            <div>
                                                <p
                                                    className="text-sm font-medium text-[#3f3d56] dark:text-white opacity-70 mb-1"
                                                    style={{ fontFamily: "Montserrat, sans-serif" }}
                                                >
                                                    Start Time
                                                </p>
                                    ...
                                    <div className="bg-[#ffe6a7]/20 dark:bg-black p-4 rounded-lg border border-[#ffe6a7]/50">
                                        <p
                                            className="text-sm font-medium text-[#3f3d56] dark:text-white opacity-70 mb-1"
                                            style={{ fontFamily: "Montserrat, sans-serif" }}
                                        >
                                    ...
                                    <div>
                                        ...
                                        <div
                                            className={`inline-flex px-3 py-2 rounded-lg text-sm font-medium border dark:bg-black dark:border-gray-700 ${getOvertimeTypeColor(request.overtimeType)}`}
                                            style={{ fontFamily: "Montserrat, sans-serif" }}
                                        >
                                            {overtimeTypes.find(ot => ot.id == request.overtimeType)
                                                ?.overtimeType ?? ""}
                    ...
                    <div className="space-y-4">
                        ...
                        <Card className="border-0 shadow-sm">
                            <CardContent className="p-6">
                                ...
                                <div className="bg-green-50 p-4 rounded-lg border border-green-200 dark:bg-black dark:border-gray-700">
                                    <p
                                        className="text-[#3f3d56] dark:text-white leading-relaxed"
                                        style={{ fontFamily: "Montserrat, sans-serif" }}
                                    >
                    ...
                    {request.hrComments && (
                        <Card className="border-0 shadow-sm bg-blue-50/50 dark:bg-black dark:border-gray-700">
                            <CardContent className="p-6">
                                <h3
                                    className="text-lg font-semibold text-[#3f3d56] dark:text-white mb-4"
                                    style={{ fontFamily: "Montserrat, sans-serif" }}
