...
import { createStorageToken } from "@/lib/backend/storage/signing";
import {
    createSignedDownload,
    createSignedUpload,
    getStorageMetadata,
    listStorageMetadata,
} from "@/lib/backend/storage/service";
import { StorageObjectMetadata, UploadRequestInput } from "@/lib/backend/storage/types";
...
export const validateStoredObjects = ({
    objectKeys,
    instanceKey,
    ownerUid,
    module,
