...
export const row22 = ({
    ...
    worksheet: ExcelJS.Worksheet;
    initialRow: number;
    contractEndData: ContractEndDataModel;
}) => {
    customCell({
        worksheet: worksheet,
        cell: `A${16 + contractEndData.row + initialRow}`,
    ...
    customCell({
        worksheet: worksheet,
        cell: `B${16 + contractEndData.row + initialRow}`,
    ...
    customCell({
        worksheet: worksheet,
        cell: `C${16 + contractEndData.row + initialRow}`,
    ...
    customCell({
        worksheet: worksheet,
        cell: `D${16 + contractEndData.row + initialRow}`,
        border: true,
    });

    customCell({
        worksheet: worksheet,
        cell: `E${16 + contractEndData.row + initialRow}`,
    ...
    customCell({
        worksheet: worksheet,
        cell: `F${16 + contractEndData.row + initialRow}`,
    ...
    customCell({
        worksheet: worksheet,
        cell: `G${16 + contractEndData.row + initialRow}`,
        mergeCell: `G${16 + contractEndData.row + initialRow}:H${
            16 + contractEndData.row + initialRow
        }`,
    ...
    customCell({
        worksheet: worksheet,
        cell: `I${16 + contractEndData.row + initialRow}`,
        border: true,
    });

    customCell({
        worksheet: worksheet,
        cell: `J${16 + contractEndData.row + initialRow}`,
        mergeCell: `J${16 + contractEndData.row + initialRow}:K${
            16 + contractEndData.row + initialRow
        }`,
    ...
    customCell({
        worksheet: worksheet,
        cell: `L${16 + contractEndData.row + initialRow}`,
        mergeCell: `L${16 + contractEndData.row + initialRow}:M${
            16 + contractEndData.row + initialRow
        }`,
        border: true,
        fill: {
