...
const getStorageSigningSecret = (): string =>
    manualEnv.jwtSecret || process.env.NEXTAUTH_SECRET || "onehr-manual-storage-dev";
...
export const createStorageToken = (inputPath: string, operation: "upload" | "download"): string => {
