...
import { createRealtimeEvent, replayEventsFromToken } from "@/lib/backend/manual/realtime/event-contract";
import { assertRealtimeSubscriptionPolicy, canReceiveRealtimeEvent } from "@/lib/backend/manual/realtime/policy";
import {
      ...
      const allowed = canReceiveRealtimeEvent(
        {
          ...
          tenantId: subscriber.request.tenantId,
