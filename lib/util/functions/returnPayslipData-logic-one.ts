...
export function buildPayrollDataForLogicOne({
    ...
    return {
        ...
        employmentPosition:
            settingsLookup.positions.find(c => c.id == employee.employmentPosition)?.name ?? "",
        department:
            settingsLookup.departmentSettings.find(c => c.id == employee.department)?.name ?? "",
        section: settingsLookup.sectionSettings.find(c => c.id == employee.section)?.name ?? "",
        ...
        workingLocation:
            settingsLookup.locations.find(c => c.id == employee.workingLocation)?.name ?? "",
        ...
        contractType:
            settingsLookup.contractTypes.find(c => c.id == employee.contractType)?.name ?? "",
    };
}
